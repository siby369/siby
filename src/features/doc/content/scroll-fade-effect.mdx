...
image: https://assets.Siby.com/images/blog/scroll-fade-effect.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://Siby.com/r/scroll-fade-effect.json"
/>
...
```bash
npx shadcn add @siby369/scroll-fade-effect
```

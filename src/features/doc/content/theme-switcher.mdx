...
image: https://assets.Siby.com/images/blog/theme-switcher-component.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://Siby.com/r/theme-switcher.json"
/>
...
```bash
npx shadcn add @siby369/theme-switcher
```
